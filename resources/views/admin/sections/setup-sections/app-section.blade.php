        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#app-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Item ") }}</a>
                </div>
            </div>
    ...
    <script>
        ...
        $(".edit-modal-button").click(function(){
            ...
            $.each(languages,function(index,item) {
                ...
                editModal.find("input[name="+item.code+"_sub_title_edit]").val(oldData.language[item.code]?.sub_title);   
            }); 
